  ...
  return (
    <div className="flex h-screen flex-col bg-neutral-50">
      ...
      <div className="border-b border-neutral-200 bg-white px-6 py-4">
        <h1 className="text-2xl font-bold text-neutral-900">FileComparison Component Demo</h1>
        ...
        <div className="mt-4 flex flex-wrap items-center gap-4">
          ...
          <div className="flex items-center gap-2">
            <label className="text-sm font-medium text-neutral-700">Scenario:</label>
            <select
              value={scenario}
              onChange={(e) => setScenario(e.target.value as DemoScenario)}
              className="rounded-md border border-neutral-300 bg-white px-3 py-1.5 text-sm focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500"
            >
          ...
          {/* View mode toggle */}
          <div className="flex items-center gap-2">
            <label className="text-sm font-medium text-neutral-700">View Mode:</label>
      ...
      <div className="flex-1 overflow-auto p-6">
        <div className="h-full rounded-lg border border-neutral-200 bg-white shadow-sm">
          <FileComparison
