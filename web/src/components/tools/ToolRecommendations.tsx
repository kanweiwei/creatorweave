    ...
    <div className={`rounded-xl border border-amber-200 bg-amber-50/50 ${className}`}>
      ...
      <div className="flex items-center justify-between px-4 py-3">
        <div className="flex items-center gap-2">
          ...
          <div>
            <h3 className="text-sm font-medium text-neutral-900">Recommended Tools</h3>
          ...
          <div key={rec.toolName} className="px-4 py-3">
            <div className="flex items-start justify-between gap-3">
              ...
              <div className="min-w-0 flex-1">
                ...
                <p className="mb-2 text-xs text-neutral-600">{rec.reason}</p>

                {/* Example */}
                <div className="group relative">
                  <div className="rounded-lg border border-neutral-200 bg-white px-3 py-2">
                    <code className="block overflow-x-auto text-xs text-neutral-700">
                      {rec.example}
                    </code>
                  </div>
                  {/* Copy button */}
                  <button
                    ...
                    className="absolute right-2 top-1/2 -translate-y-1/2 rounded-md p-1.5 text-neutral-400 opacity-0 transition-opacity hover:bg-neutral-100 hover:text-neutral-600 group-hover:opacity-100"
                  >
              ...
              {/* Category badge */}
              <span className="flex-shrink-0 rounded-md border border-neutral-200 bg-white px-2 py-1 text-xs font-medium text-neutral-600">
                {rec.category}
              </span>
            </div>
          </div>
    ...
    <div className="flex items-center gap-2 px-2 py-1">
      ...
      {suggestions.map((rec) => (
        <button
          ...
          className="inline-flex items-center gap-1 rounded-md bg-neutral-100 px-2 py-1 text-xs text-neutral-600 transition-colors hover:bg-neutral-200"
        >
