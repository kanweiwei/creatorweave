        ...
        <div className="px-6 py-4 border-b border-gray-200 bg-gray-50">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 className="text-lg font-semibold text-gray-900">文件冲突</h2>
          ...
          <div className="mt-4 flex items-center gap-6 text-sm">
            <div className="flex items-center gap-2">
              <span className="text-gray-500">OPFS 版本时间:</span>
            ...
            {conflict.nativeVersion.mtime && (
              <div className="flex items-center gap-2">
                <span className="text-gray-500">本机版本时间:</span>
                <span className="font-medium text-gray-900">
        ...
        <div className="flex-1 overflow-auto p-6">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 mb-6">
            ...
            <div className="lg:col-span-1 space-y-3">
              <h3 className="text-sm font-medium text-gray-700 mb-3">选择解决方案</h3>
              {options.map((option) => (
                <button
                  key={option.value}
            ...
            <div className="lg:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="flex flex-col bg-gray-50 rounded-lg overflow-hidden">
